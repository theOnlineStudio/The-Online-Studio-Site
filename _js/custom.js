...
$('#highlight').show();
	...
	function navSlider(whatPage){
		switch (whatPage){
			case "": 		$('#highlight').animate({'right' : '645px', 'width':'0px'},time, function(){$('#homeNav').addClass('active')}); 	break;
			case "what": 	$('#highlight').animate({'right' : '542px', 'width':'83px'},time, function(){$('#whatNav').addClass('active')});	break;
			case "why": 	$('#highlight').animate({'right' : '475px', 'width':'65px'},time, function(){$('#whyNav').addClass('active')});		break;
			case "work":	$('#highlight').animate({'right' : '400px', 'width':'72px'},time, function(){$('#workNav').addClass('active')});	break;
			case "who":  	$('#highlight').animate({'right' : '315px', 'width':'82px'},time, function(){$('#whoNav').addClass('active')});		break;
			case "contact":	$('#highlight').animate({'right' : '249px', 'width':'64px'},time, function(){$('#contactNav').addClass('active')}); break;
		}
	}
