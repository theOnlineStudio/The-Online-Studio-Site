...
<head>
  <meta charset="utf-8">
	...
	<meta name="description" CONTENT="<?php 
		function doPageMeta($url){
			switch ($url){
				case "why": 
					echo 'The Online Studio gives you all the benefits of outsourcing digital production but none of the headaches. '; 
				break;
				case "what": 
					echo 'We provide access to world class digital talent.'; 
				break;
				case "who": 
					echo 'Our UK management team provide access to technical production staff based around the globe.'; 
				break;
				case "work": 
					echo 'We work on all manner of digital projects including websites, microsites, Facebook and mobile apps, as well as banners and html emails.'; 
				break;
				case "contact": 
					echo 'Get in touch for a quote or a chat'; 
				break;
				case "blog": 
					echo 'The blog'; 
				break;
				default;
				echo "The Online Studio provides expertise and end to end solutions to all your digital production requirements.";

			}
		}
		doPageMeta(basename($_SERVER['PHP_SELF'], ".php"));
...
<div class="wrapper">
	...
	<div id="phone">PHONE &nbsp;&nbsp; +44 &nbsp;207&nbsp; 723&nbsp; 4703 </div>
		</div>
		<div id="minHeight">